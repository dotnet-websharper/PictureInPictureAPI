...
function d(){ const fU=null;return new Promise((fV) => { fV(new Promise((fW) => { const fX=globalThis.document;let fY=!(fX.pictureInPictureElement==null)?fX.exitPictureInPicture().then(() => Promise.resolve(null)):(f().requestPictureInPicture(),Promise.resolve(null));fW(fY);})["catch"]((fW) => { console.error("Error toggling Picture-in-Picture mode: "+String(r(fW)));return Promise.resolve(null);}));});}
