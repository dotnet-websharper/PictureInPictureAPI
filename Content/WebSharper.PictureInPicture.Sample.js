...
function Main(){
  ...
  const b=(this_1.h.push(new AfterRenderQ("pageinit", () => {
    setupPiPEvents();
    pipButton().addEventListener("click", () => {
      const _3=null;
      return StartImmediate(Delay(() => Bind(AsAsync(togglePiPMode()), () => Return(null))), null);
    });
  })),this_1);
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static video;
  static {
    this.video=globalThis.document.getElementById("video");
    this.pipButton=globalThis.document.getElementById("pipButton");
  }
});
